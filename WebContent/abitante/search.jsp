   ...
   <%@ include file="../header.jsp" %>
    ...
    <div class="page-header">
	  <h3>Pagina di Ricerca Abitante</h3>
      	...
      	<form class="form-horizontal" action="ExecuteFindAbitantiServlet" method="post">
			...
			<div class="form-group">
		      ...
		      <div class="col-sm-offset-2 col-sm-10">
		        ...
		        <a href="PrepareNewInsertAbitanteServlet" class="btn btn-primary btn-md">Inserisci Nuovo Elemento</a>
		      </div>
		    </div>
		</form>
