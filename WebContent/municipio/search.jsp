   ...
   <%@ include file="../header.jsp" %>
    ...
    <div class="page-header">
	  <h3>Pagina di Ricerca Municipio</h3>
      	...
      	<form class="form-horizontal" action="ExecuteFindMunicipiServlet" method="post">
			...
			<div class="form-group">
		      ...
		      <div class="col-sm-offset-2 col-sm-10">
		        ...
		        <a href="prepareNewInsertServlet" class="btn btn-primary btn-md">Inserisci Nuovo Elemento</a>
		      </div>
		    </div>
		</form>
