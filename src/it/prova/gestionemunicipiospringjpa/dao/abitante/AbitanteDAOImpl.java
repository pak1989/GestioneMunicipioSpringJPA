...
public class AbitanteDAOImpl implements AbitanteDAO {
	...
	public List<Abitante> listNotLazy() {
		return entityManager.createQuery("from Abitante ab JOIN FETCH ab.municipio").getResultList();
	}
	...
	public List<Abitante> findAllByMunicipio(Long idMunicipio) {
		Query query = entityManager
				.createQuery("select ab FROM Abitante ab JOIN FETCH ab.municipio mun WHERE mun.id = :idMunicipio")
